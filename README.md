...
2. Log in to [Discogs](https://www.discogs.com/settings/developers) and generate your API Token. For more API Discogs documentation, [read here](https://www.discogs.com/developers/)
3. Input YOUR_API_TOKEN and YOUR_SELLER_USERNAME(name of a shop you want to fetch data from) into [wantlist_vs_seller_matcher.ipynb](https://github.com/OpAlliance/discogs_wantlist_inventory_matcher/blob/main/wantlist_vs_seller_matcher.ipynb) and execute the Jupyter Notebook!
